...
if __name__ == '__main__':
	while True:
		try:
			...
			frame_text=('BI1FQO-P>APDG03,TCPIP*,qAC,BI1FQO-SU7:!%s%s/%s%s>%s/%s/A=%s Auto Report by RPI with GPS module at UTC %s on 逗老师的Xiaomi Su7 Max'%(lat,lat_dir,lon,lon_dir,course,speed,altitude,timestamp)).encode()
